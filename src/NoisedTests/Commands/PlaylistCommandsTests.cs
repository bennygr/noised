...
namespace NoisedTests.Commands
{
    ...
    public class PlaylistCommandsTests
    {
        ...
        public void PlaylistCommandsTestsFixtureSetUp()
        {
            ...
            playlistManager.DbFactory = mockFactory.Object;
        }

        [Test]
        public void CreatePlaylistCommandTest()
        {
            int initialCount = playlistManager.Playlists.Count;

            new CreatePlaylist(new Mock<IServiceConnectionContext>().Object, "CreatePlaylistCommandTest").ExecuteCommand();
