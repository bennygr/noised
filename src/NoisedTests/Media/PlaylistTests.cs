...
namespace NoisedTests.Media
{
    ...
    public class PlaylistTests
    {
        ...
        [Test]
        [ExpectedException(typeof(ArgumentException), UserMessage = "Creating a Playlist with an empty name should return in an ArgumentException")]
        ...
        public void MediaItemShouldBeAddable()
        {
            ...
            playlist.GetNext().ShouldEqual(listable, "The GetNext Method should return the only MediaItem if available.");
        }
        ...
        public void MediaItemShouldBeRemovable()
        {
            ...
            playlist.GetNext().ShouldEqual(null, "The GetNext Method of a Playlist should return null if no Items are available.");
            ...
            playlist.GetNext().ShouldEqual(null, "The NextItem Property of a Playlist should return null if no Items are available.");
        }
        ...
        public void MultipleMediaItemsShouldBeAddable()
        {
            ...
            playlist.GetNext().ShouldEqual(listable1, "After adding Items the GetNext() Method should return the Items in the order they were added.");
            playlist.GetNext().ShouldEqual(listable2, "After adding Items the GetNext() Method should return the Items in the order they were added.");
            playlist.GetNext().ShouldEqual(null, "After returning all Items the GetNext() Method should return null.");

            playlist.Reset();

            playlist.GetNext().ShouldEqual(listable1, "After resetting the PlayedItems on the Playlist the GetNext() Method should return the Items in the order they were added.");
            playlist.GetNext().ShouldEqual(listable2, "After resetting the PlayedItems on the Playlist the GetNext() Method should return the Items in the order they were added.");
            playlist.GetNext().ShouldEqual(null, "After returning all Items the GetNext() Method should return null.");
        }
    }
}
